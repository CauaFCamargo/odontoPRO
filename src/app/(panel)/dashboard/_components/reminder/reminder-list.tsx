...
import { Reminder } from "@/src/generated/prisma/client"
        ...
        <div className="flex flex-col gap-3">
            <Card>
                ...
                <CardContent>
                    ...
                    <ScrollArea className="h-85 lg:max-h-[calc(100vh-15)] pr-0 w-full flex-1">
                    {reminder.map((item) => (
                        <article
                        key={item.id}
                        ...
                        <Button
                            className="bg-red-500 hover:bg-red-400 shadow-none rounded-full p-2" // w-9 h-9 testar depois
                            size="sm"
